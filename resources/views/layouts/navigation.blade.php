    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @if(Auth::user()->role->nombre_rol == 'Admin')
            ...
            <div class="pt-4 pb-1 border-t border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('admin.reportes.module.form')" :active="request()->routeIs('admin.reportes.*')">
                        Reporte de Módulo
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.reportes.viveros.show')" :active="request()->routeIs('admin.reportes.*')">
                        Reporte de Viveros
                    </x-responsive-nav-link>
                </div>
            </div>
