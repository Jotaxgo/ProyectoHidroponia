                ...
                <form method="POST" action="{{ route('admin.viveros.store') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="user_id" id="select-dueño" class="block mt-1 w-full bg-hydro-dark border-hydro-border text-white focus:border-hydro-accent-gold focus:ring-hydro-accent-gold rounded-md shadow-sm">
