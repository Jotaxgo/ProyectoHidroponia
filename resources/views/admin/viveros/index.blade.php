                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50 dark:bg-gray-700 ">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider text-center">Modulos</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.viveros.modulos.index', $vivero) }}" class="text-indigo-600 hover:text-indigo-900 underline text-center">
